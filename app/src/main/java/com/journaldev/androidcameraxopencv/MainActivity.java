...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    final private int REQUEST_CODE_PERMISSIONS = 101;
    ...
    private ImageAnalysis setImageAnalysis() {
        ...
        imageAnalysis.setAnalyzer(
                (image, rotationDegrees) -> {
                    ...
                    if (bitmap == null)
                        return;
                    //bitmap = generateCircularBitmap(bitmap);
                    // Calculate mid red point
                   ...
                   // Imgproc.cvtColor(mat, mat, currentImageType );
                    ...
                    Imgproc.putText(mat, "Test:W"+wbitmap+":H"+hbitmap+":P"+ points,new Point(50, 50),Core.FONT_HERSHEY_SIMPLEX,0.5,new Scalar(0, 0, 0),2 );
                   // Imgproc.cvtColor(mat, mat, currentImageType);
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            ivBitmap.setImageBitmap(bitmap2);
                        }
                    });
    ...
    public Bitmap generateCircularBitmap(Bitmap input) {
        ...
        // Calculate mid red point
        int wbitmap = input.getWidth();
        int hbitmap = input.getHeight();
        int x = 0;
        int y = 0;
        int all_x = 0;
        int all_y = 0;
        ...
        path.addCircle(x_center, y_center
                , (float) Math.min(wbitmap/10, (hbitmap / 20))
                , Path.Direction.CCW);
